...
export const CHANNEL_CATALOG: ChannelMeta[] = [
  ...
  { type: "telegram_app", name: "Telegram App", descKey: "int.channel.desc.telegram_app", connectable: false },
  ...
  { type: "tiktok_app", name: "TikTok App", descKey: "int.channel.desc.tiktok_app", connectable: false, glyph: "TT" },
  ...
  { type: "wechat", name: "微信", descKey: "int.channel.desc.wechat", connectable: false },
